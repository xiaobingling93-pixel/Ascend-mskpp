...
### 工具安装
介绍msKPP工具的环境依赖及安装方式，具体请参见[MindStudio Kernel Performance Prediction安装指南](./docs/zh/mskpp_install_guide.md)。


##  快速入门
msKPP工具详细的快速入门请参见[MindStudio Kernel Performance Prediction快速入门](./docs/zh/mskpp_quick_start.md)。
...
- [算子特性建模](./docs/zh/mskpp_user_guide.md/##算子特性建模功能介绍)：基于msKPP提供的接口模拟出算子耗时。
- [算子计算搬运规格分析](./docs/zh/mskpp_user_guide.md/##算子计算搬运规格分析功能介绍)：生成搬运流水统计文件和指令信息统计文件，可查看msKPP建模结果。
- [极限性能分析](./docs/zh/mskpp_user_guide.md/##极限性能分析功能介绍)：生成文件指令流水图和指令占比饼图，可查看msKPP建模结果。
-  [算子tiling初步设计](./docs/zh/mskpp_user_guide.md/##算子tiling初步设计功能)：能够快速筛选出几种较优的tiling策略。



## API参考
msKPP工具分为基础功能接口和指令接口两种接口类型。具体内容请参见[MindStudio Kernel Performance Prediction对外接口使用说明](./docs/zh/mskpp_api_reference.md)。
