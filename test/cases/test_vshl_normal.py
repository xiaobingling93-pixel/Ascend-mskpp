...
import os
import unittest
from mskpp import vshl, Tensor, Chip
...
class TestUtilsMethods(TestBase):
    ...
    def test_vshl_normal(self):
        with Chip("Ascend910B1") as chip:
            ...
            out_y = my_vshl(in_x)
            out_y_int32 = my_vshl(in_x_int32)
            out_y_uint16 = my_vshl(in_x_uint16)
            out_y_uint32 = my_vshl(in_x_uint32)
            in_y.load(out_y)
