    ...
    def test_vadds_normal(self):
        with Chip("Ascend910B1") as chip:
            ...
            for _ in range(1):
                ...
                out_z = my_vadds(in_x, in_y, in_z)  # out == in_z
                in_z.load(out_z)
