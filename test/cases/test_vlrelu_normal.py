...
import os
import unittest
from mskpp import vlrelu, Tensor, Chip
...
def my_vlrelu(gm_x, scalar_y):
    ub_x, ub_z = Tensor(UB_MEM), Tensor(UB_MEM)
    ub_x.load(gm_x)
    out = vlrelu(ub_x, scalar_y, ub_z)()  # 对于输出需要返回传出
    return out[0]
